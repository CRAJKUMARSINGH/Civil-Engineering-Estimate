#!/usr/bin/env python3
"""
Convert Excel project files to GEstimator .eproj format
"""
...
def create_gestimator_database(output_path, project_name):
    ...
    # Get ORM models
    orm_models = schedule.get_orm_model(db)
...
def main(debug=False):
    ...
    # Debug mode - just show file structure
    if debug:
        print(f"\n{'='*80}")
        print("DEBUG MODE - ANALYZING EXCEL FILES")
        print(f"{'='*80}")
        return 0
